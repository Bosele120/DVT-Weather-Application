...
public class UIMainActivity extends AppCompatActivity{
    ...
    public DVTDataManagement dataManagement; /* this varibale will help to manage data */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            Intent weatherService=new Intent(getApplicationContext(),DVTWeatherRealTimeUpdate.class);
            ...
            dataManagement=new DVTDataManagement(getApplicationContext());
            ...
            savedLocation.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent locationActivity = new Intent(getApplicationContext(), UISavedLocation.class);
            ...
            settingButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent settingActivity = new Intent(getApplicationContext(), UISettingActivity.class);
