...
public class UIViewWeatherDetails extends AppCompatActivity {
    ...
    private DVTDataManagement dataManagement;
               ...
               if(data!=null){
                   ...
                   if(data instanceof JSONArray){
                       ...
                       if(isThisPlaceIsSaved(cInfo.countryName,cInfo.cityName)){
                           savedToFavIco.setImageResource(R.drawable.ic_baseline_fullstar_24);
                           ...
                           public void onClick(View view) {
                               ...
                               if(isThisPlaceIsSaved(cInfo.countryName,cInfo.cityName)){
                                   ...
                                   if(dataManagement.removeItemToFavList(cInfo.countryName,cInfo.cityName)){
                                       savedToFavIco.setImageResource(R.drawable.ic_baseline_star_border_24);
